describe('d2l-filter-menu-tab-roles-legacy', function() {
	...
	beforeEach(function() {
		...
		component = fixture('d2l-filter-menu-tab-roles-legacy-fixture');
	...
	describe('clear', function() {
		it('should reset the "selected" state to false on all filter items', function() {
			...
			var filters = component.$$('d2l-menu').querySelectorAll('d2l-filter-list-item-role-legacy');
